...
@property (weak, nonatomic) IBOutlet UIView *settingBackgrounView;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *toolBarBottomLayoutConstraint;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *topViewTopLayoutConstraint;
        ...
        if (state != kDrawingStateMoved) {
            if (state == kDrawingStateBegin) {
                [UIView animateWithDuration:1.8 animations:^{
                    weakSelf.topViewTopLayoutConstraint.constant = -44;
                    weakSelf.toolBarBottomLayoutConstraint.constant = 250+44;
                ...
                [UIView animateWithDuration:1.8 animations:^{
                    weakSelf.topViewTopLayoutConstraint.constant = 0;
                    weakSelf.toolBarBottomLayoutConstraint.constant = 0;
...
- (void)p_setupBrushSettingsView {
    ...
    PaintingBrushSettingView *brushSettingsView = (PaintingBrushSettingView *)[arr firstObject];
     brushSettingsView.frame = CGRectMake(0, 0, kScreenWidth, 250);
    brushSettingsView.hidden = YES;
    brushSettingsView.tag = 101;
    [self.settingBackgrounView addSubview:brushSettingsView];
...
- (void)p_setupBackgroundSettingsView {
    ...
    backgroundSettingsView.frame = CGRectMake(0, 70, kScreenWidth, 180);
    backgroundSettingsView.hidden = YES;
    backgroundSettingsView.tag = 102;
    [self.settingBackgrounView addSubview:backgroundSettingsView];
